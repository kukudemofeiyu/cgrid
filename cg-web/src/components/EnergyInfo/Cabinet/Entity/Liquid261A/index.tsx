 ...
 * @LastEditTime: 2024-12-31 09:34:49
 * @LastEditors: YangJianFei
 * @FilePath: /energy-cloud-frontend/src/components/EnergyInfo/Cabinet/Entity/Liquid261A/index.tsx
 */
...
import Energy261AImg from '@/assets/image/station/liquid-261-a/energy.png';
...
import LiquidAirLineImg from '@/assets/image/station/liquid-261-a/liquid-coor-line.png';
import LiquidEmsLineImg from '@/assets/image/station/liquid-wind-energy/ems-line.png';
import LiquidBmsLineImg from '@/assets/image/station/liquid-261-a/bms-line.png';
import FireFightImg from '@/assets/image/station/energy/fire-fight.png';
import LiquidFireFightLineImg from '@/assets/image/station/liquid-261-a/firefight-line.png';
import LiquidStackLineImg from '@/assets/image/station/liquid-wind-energy/stack-line.png';
import LiquidPcsLineImg from '@/assets/image/station/liquid-261-a/pcs-line.png';
import DehumidiferImg from '@/assets/image/station/liquid-energy/dehumidifier.png';
import DehumidiferLineImg from '@/assets/image/station/liquid-261-a/dehumidifier-line.png';
...
const configs: ConfigType[] = [
  ...
  },
  {
    ...
    position: { top: 360, left: 2 },
    icon: DehumidiferImg,
    line: DehumidiferLineImg,
    linePosition: { top: 15, left: 92, width: 238 },
    data: [
      {
        label: formatMessage({ id: 'siteMonitor.workingMode', defaultMessage: '工作模式' }),
        field: 'WorkMode',
  ...
  },
  {
    ...
    position: { top: 520, left: 2 },
    icon: PcsImg,
    line: LiquidPcsLineImg,
    linePosition: { top: 23, left: 116, width: 367 },
    data: [
      {
        label: formatMessage({ id: 'siteMonitor.workingMode', defaultMessage: '工作模式' }),
  ...
  },
  {
    ...
    productTypeId: DeviceProductTypeEnum.BatteryCluster,
    dataProductTypeIds: [DeviceProductTypeEnum.Ems],
    position: { top: 112, left: 768 },
    icon: StackImg,
    line: LiquidBmsLineImg,
    linePosition: { top: 24, left: -166, width: 152 },
    data: [
      {
        label: formatMessage({ id: 'siteMonitor.workingMode', defaultMessage: '工作模式' }),
  ...
  },
  {
    ...
    productTypeId: DeviceProductTypeEnum.BatteryCluster,
    position: { top: 268, left: 768 },
    icon: PeakImg,
    line: LiquidStackLineImg,
    linePosition: { top: 18, left: -152, width: 140 },
    data: [
      {
  ...
  },
  {
    ...
    position: { top: 539, left: 768 },
    icon: LiquidAirImg,
    line: LiquidAirLineImg,
    linePosition: { top: -32, left: -220, width: 213 },
    data: [
      {
  ...
  },
  {
    ...
    position: { top: 15, left: 768 },
    icon: FireFightImg,
    line: LiquidFireFightLineImg,
    linePosition: { top: 25, left: -166, width: 158 },
    data: [
      {
        field: 'alms',
      },
