...
import com.things.cgomp.system.domain.SysConfig;
import com.things.cgomp.system.enums.ErrorCodeConstants;
import com.things.cgomp.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    public void deleteConfigByIds(Long[] configIds)
    {
        for (Long configId : configIds)
        {
            ...
            {
                throw exception(ErrorCodeConstants.SYSTEM_INNER_CONFIG_CAN_NOT_DELETE, config.getConfigKey());
            }
