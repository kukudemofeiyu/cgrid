...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus)
    {
        ...
        for (SysMenu menu : menus)
        {
            ...
            router.setHidden(menu.getVisible() != null && menu.getVisible().equals(1));
            router.setName(getRouteName(menu));
            router.setPath(getRouterPath(menu));
            router.setComponent(getComponent(menu));
            router.setQuery(menu.getQuery());
            router.setMeta(new MetaVo(menu.getMenuName(), menu.getIcon(), menu.getIsCache() != null && menu.getIsCache().equals(1), menu.getPath()));
            ...
            else if (isMenuFrame(menu))
            {
                ...
                children.setMeta(new MetaVo(menu.getMenuName(), menu.getIcon(),menu.getIsCache() != null && menu.getIsCache().equals(1), menu.getPath()));
