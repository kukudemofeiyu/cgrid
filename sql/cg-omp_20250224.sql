...
-- 初始化-部门表数据
-- ----------------------------
insert into system_dept values(100,  0,   '0',          'XX',   0, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(101,  100, '0,100',      '深圳总公司', 1, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(102,  100, '0,100',      '长沙分公司', 2, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(103,  101, '0,100,101',  '研发部门',   1, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(104,  101, '0,100,101',  '市场部门',   2, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(105,  101, '0,100,101',  '测试部门',   3, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(106,  101, '0,100,101',  '财务部门',   4, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(107,  101, '0,100,101',  '运维部门',   5, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(108,  102, '0,100,102',  '市场部门',   1, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into system_dept values(109,  102, '0,100,102',  '财务部门',   2, '测试', '15888888888', 'xx@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into system_user values(1,  103, 'admin', '超级管理员', '00', 'admin@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '超级管理员');
...
-- ----------------------------
-- 一级菜单
insert into system_menu values('1', '系统管理', '0', '1', 'system',           null, '', '', 1, 0, 'M', '0', '0', '', 'system',   'admin', sysdate(), '', null, '系统管理目录');
insert into system_menu values('2', '系统监控', '0', '2', 'monitor',          null, '', '', 1, 0, 'M', '0', '0', '', 'monitor',  'admin', sysdate(), '', null, '系统监控目录');
insert into system_menu values('3', '系统工具', '0', '3', 'tool',             null, '', '', 1, 0, 'M', '0', '0', '', 'tool',     'admin', sysdate(), '', null, '系统工具目录');
-- 二级菜单
insert into system_menu values('100',  '用户管理',       '1',   '1', 'user',       'system/user/index',                 '', '', 1, 0, 'C', '0', '0', 'system:user:list',        'user',          'admin', sysdate(), '', null, '用户管理菜单');
insert into system_menu values('101',  '角色管理',       '1',   '2', 'role',       'system/role/index',                 '', '', 1, 0, 'C', '0', '0', 'system:role:list',        'peoples',       'admin', sysdate(), '', null, '角色管理菜单');
insert into system_menu values('102',  '菜单管理',       '1',   '3', 'menu',       'system/menu/index',                 '', '', 1, 0, 'C', '0', '0', 'system:menu:list',        'tree-table',    'admin', sysdate(), '', null, '菜单管理菜单');
insert into system_menu values('103',  '部门管理',       '1',   '4', 'dept',       'system/dept/index',                 '', '', 1, 0, 'C', '0', '0', 'system:dept:list',        'tree',          'admin', sysdate(), '', null, '部门管理菜单');
insert into system_menu values('104',  '岗位管理',       '1',   '5', 'post',       'system/post/index',                 '', '', 1, 0, 'C', '0', '0', 'system:post:list',        'post',          'admin', sysdate(), '', null, '岗位管理菜单');
insert into system_menu values('105',  '字典管理',       '1',   '6', 'dict',       'system/dict/index',                 '', '', 1, 0, 'C', '0', '0', 'system:dict:list',        'dict',          'admin', sysdate(), '', null, '字典管理菜单');
insert into system_menu values('106',  '参数设置',       '1',   '7', 'config',     'system/config/index',               '', '', 1, 0, 'C', '0', '0', 'system:config:list',      'edit',          'admin', sysdate(), '', null, '参数设置菜单');
insert into system_menu values('107',  '通知公告',       '1',   '8', 'notice',     'system/notice/index',               '', '', 1, 0, 'C', '0', '0', 'system:notice:list',      'message',       'admin', sysdate(), '', null, '通知公告菜单');
insert into system_menu values('108',  '日志管理',       '1',   '9', 'log',        '',                                  '', '', 1, 0, 'M', '0', '0', '',                        'log',           'admin', sysdate(), '', null, '日志管理菜单');
insert into system_menu values('109',  '在线用户',       '2',   '1', 'online',     'monitor/online/index',              '', '', 1, 0, 'C', '0', '0', 'monitor:online:list',     'online',        'admin', sysdate(), '', null, '在线用户菜单');
insert into system_menu values('110',  '定时任务',       '2',   '2', 'job',        'monitor/job/index',                 '', '', 1, 0, 'C', '0', '0', 'monitor:job:list',        'job',           'admin', sysdate(), '', null, '定时任务菜单');
insert into system_menu values('111',  'Sentinel控制台', '2',   '3', 'http://localhost:8718',        '',                '', '', 0, 0, 'C', '0', '0', 'monitor:sentinel:list',   'sentinel',      'admin', sysdate(), '', null, '流量控制菜单');
insert into system_menu values('112',  'Nacos控制台',    '2',   '4', 'http://localhost:8848/nacos',  '',                '', '', 0, 0, 'C', '0', '0', 'monitor:nacos:list',      'nacos',         'admin', sysdate(), '', null, '服务治理菜单');
insert into system_menu values('113',  'Admin控制台',    '2',   '5', 'http://localhost:9100/login',  '',                '', '', 0, 0, 'C', '0', '0', 'monitor:server:list',     'server',        'admin', sysdate(), '', null, '服务监控菜单');
insert into system_menu values('114',  '表单构建',       '3',   '1', 'build',      'tool/build/index',                  '', '', 1, 0, 'C', '0', '0', 'tool:build:list',         'build',         'admin', sysdate(), '', null, '表单构建菜单');
insert into system_menu values('115',  '代码生成',       '3',   '2', 'gen',        'tool/gen/index',                    '', '', 1, 0, 'C', '0', '0', 'tool:gen:list',           'code',          'admin', sysdate(), '', null, '代码生成菜单');
insert into system_menu values('116',  '系统接口',       '3',   '3', 'http://localhost:8080/swagger-ui/index.html', '', '', '', 0, 0, 'C', '0', '0', 'tool:swagger:list',       'swagger',       'admin', sysdate(), '', null, '系统接口菜单');
-- 三级菜单
insert into system_menu values('500',  '操作日志', '108', '1', 'operlog',    'system/operlog/index',    '', '', 1, 0, 'C', '0', '0', 'system:operlog:list',    'form',          'admin', sysdate(), '', null, '操作日志菜单');
insert into system_menu values('501',  '登录日志', '108', '2', 'logininfor', 'system/logininfor/index', '', '', 1, 0, 'C', '0', '0', 'system:logininfor:list', 'logininfor',    'admin', sysdate(), '', null, '登录日志菜单');
-- 用户管理按钮
...
-- 操作日志按钮
insert into system_menu values('1039', '操作查询', '500', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:operlog:query',       '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1040', '操作删除', '500', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:operlog:remove',      '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1041', '日志导出', '500', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:operlog:export',      '#', 'admin', sysdate(), '', null, '');
-- 登录日志按钮
insert into system_menu values('1042', '登录查询', '501', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:query',    '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1043', '登录删除', '501', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:remove',   '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1044', '日志导出', '501', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:export',   '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1045', '账户解锁', '501', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'system:logininfor:unlock',   '#', 'admin', sysdate(), '', null, '');
-- 在线用户按钮
...
-- 代码生成按钮
insert into system_menu values('1055', '生成查询', '115', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:query',             '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1056', '生成修改', '115', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:edit',              '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1057', '生成删除', '115', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:remove',            '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1058', '导入代码', '115', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:import',            '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1059', '预览代码', '115', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:preview',           '#', 'admin', sysdate(), '', null, '');
insert into system_menu values('1060', '生成代码', '115', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:code',              '#', 'admin', sysdate(), '', null, '');
...
insert into system_dict_type values(1,  '用户性别', 'system_user_sex',        '0', 'admin', sysdate(), '', null, '用户性别列表');
insert into system_dict_type values(2,  '菜单状态', 'system_show_hide',       '0', 'admin', sysdate(), '', null, '菜单状态列表');
insert into system_dict_type values(3,  '系统开关', 'system_normal_disable',  '0', 'admin', sysdate(), '', null, '系统开关列表');
insert into system_dict_type values(4,  '任务状态', 'system_job_status',      '0', 'admin', sysdate(), '', null, '任务状态列表');
insert into system_dict_type values(5,  '任务分组', 'system_job_group',       '0', 'admin', sysdate(), '', null, '任务分组列表');
insert into system_dict_type values(6,  '系统是否', 'system_yes_no',          '0', 'admin', sysdate(), '', null, '系统是否列表');
insert into system_dict_type values(7,  '通知类型', 'system_notice_type',     '0', 'admin', sysdate(), '', null, '通知类型列表');
insert into system_dict_type values(8,  '通知状态', 'system_notice_status',   '0', 'admin', sysdate(), '', null, '通知状态列表');
insert into system_dict_type values(9,  '操作类型', 'system_oper_type',       '0', 'admin', sysdate(), '', null, '操作类型列表');
insert into system_dict_type values(10, '系统状态', 'system_common_status',   '0', 'admin', sysdate(), '', null, '登录状态列表');
...
insert into system_dict_data values(1,  1,  '男',       '0',       'system_user_sex',        '',   '',        'Y', '0', 'admin', sysdate(), '', null, '性别男');
insert into system_dict_data values(2,  2,  '女',       '1',       'system_user_sex',        '',   '',        'N', '0', 'admin', sysdate(), '', null, '性别女');
insert into system_dict_data values(3,  3,  '未知',     '2',       'system_user_sex',        '',   '',        'N', '0', 'admin', sysdate(), '', null, '性别未知');
insert into system_dict_data values(4,  1,  '显示',     '0',       'system_show_hide',       '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '显示菜单');
insert into system_dict_data values(5,  2,  '隐藏',     '1',       'system_show_hide',       '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '隐藏菜单');
insert into system_dict_data values(6,  1,  '正常',     '0',       'system_normal_disable',  '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '正常状态');
insert into system_dict_data values(7,  2,  '停用',     '1',       'system_normal_disable',  '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '停用状态');
insert into system_dict_data values(8,  1,  '正常',     '0',       'system_job_status',      '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '正常状态');
insert into system_dict_data values(9,  2,  '暂停',     '1',       'system_job_status',      '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '停用状态');
insert into system_dict_data values(10, 1,  '默认',     'DEFAULT', 'system_job_group',       '',   '',        'Y', '0', 'admin', sysdate(), '', null, '默认分组');
insert into system_dict_data values(11, 2,  '系统',     'SYSTEM',  'system_job_group',       '',   '',        'N', '0', 'admin', sysdate(), '', null, '系统分组');
insert into system_dict_data values(12, 1,  '是',       'Y',       'system_yes_no',          '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '系统默认是');
insert into system_dict_data values(13, 2,  '否',       'N',       'system_yes_no',          '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '系统默认否');
insert into system_dict_data values(14, 1,  '通知',     '1',       'system_notice_type',     '',   'warning', 'Y', '0', 'admin', sysdate(), '', null, '通知');
insert into system_dict_data values(15, 2,  '公告',     '2',       'system_notice_type',     '',   'success', 'N', '0', 'admin', sysdate(), '', null, '公告');
insert into system_dict_data values(16, 1,  '正常',     '0',       'system_notice_status',   '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '正常状态');
insert into system_dict_data values(17, 2,  '关闭',     '1',       'system_notice_status',   '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '关闭状态');
insert into system_dict_data values(18, 99, '其他',     '0',       'system_oper_type',       '',   'info',    'N', '0', 'admin', sysdate(), '', null, '其他操作');
insert into system_dict_data values(19, 1,  '新增',     '1',       'system_oper_type',       '',   'info',    'N', '0', 'admin', sysdate(), '', null, '新增操作');
insert into system_dict_data values(20, 2,  '修改',     '2',       'system_oper_type',       '',   'info',    'N', '0', 'admin', sysdate(), '', null, '修改操作');
insert into system_dict_data values(21, 3,  '删除',     '3',       'system_oper_type',       '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '删除操作');
insert into system_dict_data values(22, 4,  '授权',     '4',       'system_oper_type',       '',   'primary', 'N', '0', 'admin', sysdate(), '', null, '授权操作');
insert into system_dict_data values(23, 5,  '导出',     '5',       'system_oper_type',       '',   'warning', 'N', '0', 'admin', sysdate(), '', null, '导出操作');
insert into system_dict_data values(24, 6,  '导入',     '6',       'system_oper_type',       '',   'warning', 'N', '0', 'admin', sysdate(), '', null, '导入操作');
insert into system_dict_data values(25, 7,  '强退',     '7',       'system_oper_type',       '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '强退操作');
insert into system_dict_data values(26, 8,  '生成代码', '8',       'system_oper_type',       '',   'warning', 'N', '0', 'admin', sysdate(), '', null, '生成操作');
insert into system_dict_data values(27, 9,  '清空数据', '9',       'system_oper_type',       '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '清空操作');
insert into system_dict_data values(28, 1,  '成功',     '0',       'system_common_status',   '',   'primary', 'N', '0', 'admin', sysdate(), '', null, '正常状态');
insert into system_dict_data values(29, 2,  '失败',     '1',       'system_common_status',   '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '停用状态');
...
create table system_logininfor (
  ...
  key idx_system_logininfor_lt (access_time)
