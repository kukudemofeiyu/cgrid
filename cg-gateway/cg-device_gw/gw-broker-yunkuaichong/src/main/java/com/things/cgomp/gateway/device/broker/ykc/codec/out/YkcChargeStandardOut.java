...
public class YkcChargeStandardOut extends YkcMessageOut  {
    /**
     *  设备编号
     */
    ...
    public static YkcChargeStandardOut of(Integer frameSerialNo, String deviceNo,
                                          List<Integer> YkcTimeRangeFeeRate, List<YkcChargeStandardFeeOut> feeOutList) {
        return new YkcChargeStandardOut(frameSerialNo, deviceNo, YkcTimeRangeFeeRate, feeOutList);
    }
    private final static Integer TIME_RANGE_FEE_RATE_LENGTH = 48;
    private YkcChargeStandardOut(Integer frameSerialNo, String deviceNo,
                                 List<Integer> YkcTimeRangeFeeRate,
                                 List<YkcChargeStandardFeeOut> feeOutList) {
        super(frameSerialNo, DeviceOpConstantEnum.CHARGE_STANDARD_SYNC_RESP.getOpCode(), true);
