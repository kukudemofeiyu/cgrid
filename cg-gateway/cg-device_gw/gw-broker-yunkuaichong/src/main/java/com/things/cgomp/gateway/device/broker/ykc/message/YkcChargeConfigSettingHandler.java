...
@Component
@Slf4j
public class YkcChargeConfigSettingHandler extends YkcAbstractMessageHandler<YkcChargeConfigSettingIn, YkcMessageOut>{

    @Override
    public void processRead(ChannelHandlerContext ctx, SessionContext sessionContext, Session session, YkcChargeConfigSettingIn message) throws Exception {
        log.info("充电参数配置:{}", message);
    }
