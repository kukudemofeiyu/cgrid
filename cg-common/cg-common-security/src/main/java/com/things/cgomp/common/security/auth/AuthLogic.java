package com.things.cgomp.common.security.auth;

import com.things.cgomp.common.core.context.SecurityContextHolder;
import com.things.cgomp.common.core.exception.auth.NotLoginException;
import com.things.cgomp.common.core.exception.auth.NotPermissionException;
import com.things.cgomp.common.core.exception.auth.NotRoleException;
import com.things.cgomp.common.core.utils.SpringUtils;
import com.things.cgomp.common.core.utils.StringUtils;
import com.things.cgomp.common.security.annotation.Logical;
...
import com.things.cgomp.common.security.service.SecurityUserSiteService;
...
public class AuthLogic
{
    ...
    private final SecurityUserSiteService userSiteService = SpringUtils.getBean(SecurityUserSiteService.class);
    ...
    public List<Long> getSiteIds(Long userId) {
        return userSiteService.getSiteIds(userId);
    }
}
