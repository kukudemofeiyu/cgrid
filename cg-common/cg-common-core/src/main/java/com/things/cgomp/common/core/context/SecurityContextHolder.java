...
/**
 * 获取当前线程变量中的 租户id, 用户id、用户名称、Token等信息
...
public class SecurityContextHolder
{
    ...
    {
        return Convert.toLong(get(SecurityConstants.DETAILS_ORG_ID));
    }

    public static void setOrgId(String deptId)
    {
        set(SecurityConstants.DETAILS_ORG_ID, deptId);
    }
    ...
    {
        set(SecurityConstants.DETAILS_OPERATOR_ID, operatorId);
    }
